...
def send_expiring_notification():
    ...
    for drug in expiring_drugs:
        ...
        send_drug_expiry_email_alert('belohk72@gmail.com', drug_name=drug.drug_name, expiry_date=drug.exp_date)
        drug.has_been_alerted = True
        drug.save()
        time.sleep(1) # wait for 1 seconds before the next mail is sent
